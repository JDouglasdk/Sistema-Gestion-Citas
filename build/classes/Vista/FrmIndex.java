...
public class FrmIndex extends javax.swing.JFrame {
    ...
    public void Agendamiento() {
        FrmAgendamiento objAgendamiento = new FrmAgendamiento();
        objAgendamiento.setVisible(true);
        this.dispose();
    }

    public void Aprendiz() {
        FrmAprendiz objAprendiz = new FrmAprendiz();
        objAprendiz.setVisible(true);
        this.dispose();
    }

    public void Grupo() {
        FrmGrupo objGrupo = new FrmGrupo();
        objGrupo.setVisible(true);
        this.dispose();
    }

    public void Profesional() {
        FrmProfesional objProfesional = new FrmProfesional();
        objProfesional.setVisible(true);
        this.dispose();
    }

    public void HistorialClinico() {
        FrmHistorialClinico objHistorialClinico = new FrmHistorialClinico();
        objHistorialClinico.setVisible(true);
        this.dispose();
    }
    ...
    private void initComponents() {
        ...
        jButton6.setText("Historial Clinico");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(31, 31, 31)
                        .addComponent(BtnProfesional, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(59, 59, 59)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.Aprendiz();        // TODO add your handling code here:
    ...
    private void BtnAgendamientoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgendamientoActionPerformed
        this.Agendamiento();        // TODO add your handling code here:
    }//GEN-LAST:event_BtnAgendamientoActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.Grupo();        // TODO add your handling code here:
    ...
    private void BtnProfesionalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnProfesionalActionPerformed
        this.Profesional();        // TODO add your handling code here:
    }//GEN-LAST:event_BtnProfesionalActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        this.HistorialClinico();        // TODO add your handling code here:
